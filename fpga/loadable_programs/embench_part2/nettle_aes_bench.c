...
static int
verify_nettle_aes_benchmark (int res __attribute ((unused)))
{
  bool correct = true;
...
static void
nettle_aes_initialise_benchmark (void)
{
}


static int nettle_aes_benchmark_body (int rpt);

static void
nettle_aes_warm_caches (int heat)
{
  int res = nettle_aes_benchmark_body (heat);
...
static int
nettle_aes_benchmark (void)
{
  return nettle_aes_benchmark_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


static int __attribute__ ((noinline))
nettle_aes_benchmark_body (int rpt)
{
  int i;
...
void
run_nettle_aes_benchmark (void)
{
  uint64_t start_cycles;
  uint64_t stop_cycles;
  int res;

  nettle_aes_initialise_benchmark ();
  nettle_aes_warm_caches (1);

  start_cycles = embench_read_mcycle64 ();
  res = nettle_aes_benchmark ();
  stop_cycles = embench_read_mcycle64 ();

  embench_report_result ("Nettle-aes", verify_nettle_aes_benchmark (res),
