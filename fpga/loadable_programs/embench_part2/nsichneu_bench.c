...
static void
nsichneu_initialise_benchmark (void)
{
}


static int nsichneu_benchmark_body (int rpt);

static void
nsichneu_warm_caches (int heat)
{
  int res = nsichneu_benchmark_body (heat);
...
static int
nsichneu_benchmark (void)
{
  return nsichneu_benchmark_body (LOCAL_SCALE_FACTOR * CPU_MHZ);
}


/**void NSicherNeu()**/
static int __attribute__ ((noinline))
nsichneu_benchmark_body (int rpt)
{
  int j;
...
static int
verify_nsichneu_benchmark (int unused)
{
...
void
run_nsichneu_benchmark (void)
{
  uint64_t start_cycles;
  uint64_t stop_cycles;
  int res;

  nsichneu_initialise_benchmark ();
  nsichneu_warm_caches (1);

  start_cycles = embench_read_mcycle64 ();
  res = nsichneu_benchmark ();
  stop_cycles = embench_read_mcycle64 ();

  embench_report_result ("Nsichneu", verify_nsichneu_benchmark (res),
